...
namespace UdemyCarBook.Persistence.Repositories.StatisticReporsitories
{
    public class StatisticsReporsitory : IStatisticsRepository
    {
        private readonly CarBookContext _context;
        public StatisticsReporsitory(CarBookContext context)
        {
            _context = context;
        }
