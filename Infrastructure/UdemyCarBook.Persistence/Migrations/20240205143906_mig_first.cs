...
namespace UdemyCarBook.Persistence.Migrations
{
    ...
    public partial class mig_first : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CarDescripotions",
                columns: table => new
                {
                    CarDescripotionID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CarID = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarDescripotions", x => x.CarDescripotionID);
                    table.ForeignKey(
                        name: "FK_CarDescripotions_Cars_CarID",
                        column: x => x.CarID,
                        principalTable: "Cars",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarDescripotions_CarID",
                table: "CarDescripotions",
                column: "CarID");
