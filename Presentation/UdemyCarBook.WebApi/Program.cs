...
using UdemyCarBook.Persistence.Repositories.StatisticReporsitories;
...
builder.Services.AddScoped(typeof(IStatisticsRepository), typeof(StatisticsReporsitory));
